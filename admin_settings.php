...
// TODO: Handle POST for notification preferences and password change
?>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;align-items:start">
        ...
        <div class="card">
          ...
          <div class="card__body">
            ...
            <div style="margin-top:20px">
              <!-- TODO: POST to save_notification_prefs.php -->
        ...
        <div class="card">
          ...
          <div class="card__body">
            ...
            <!-- TODO: POST to change_password.php -->
            <form method="POST" action="change_password.php" onsubmit="return validatePwForm()">
              ...
              <div class="form-group">
                ...
                <div class="form-error" id="pwError" style="display:none">Passwords do not match.</div>
              </div>
...
<!-- Toggle Switch CSS (inline for self-containment) -->
<style>
...
<script>
function savePrefs() {
  // TODO: Collect checkbox values and POST to save_notification_prefs.php
...
function validatePwForm() {
  ...
  if (np !== cp) { err.style.display = 'block'; return false; }
